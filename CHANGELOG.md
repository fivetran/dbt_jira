# dbt_jira v0.9.1
## Bug Fixes
- Created `set_safe_col_name` macro which checks that that the `issue_field_history_columns` contain safe column name for the database engine (e.g. remove leading numeric character from column name).
## Contributors
