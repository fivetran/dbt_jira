...
| `jira__daily_sprint_issue_history` | Removed column | Included `updated_at` column | Column removed | **Breaking:** Previously model tracked timestamp when sprint assignment was updated. New logic uses date-range based membership instead of tracking individual update events. [PR #169](https://github.com/fivetran/dbt_jira/pull/169) |
