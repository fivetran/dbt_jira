...
{% set exclude_columns = ['open_duration_seconds', 'any_assignment_duration_seconds', 'last_assignment_duration_seconds', 'conversation', 'story_points', 'story_point_estimate'] %}
with prod as (
