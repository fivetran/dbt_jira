...
{% set exclude_columns = ['open_duration_seconds', 'any_assignment_duration_seconds', 'last_assignment_duration_seconds', 'conversation', 'current_story_points', 'current_estimated_story_points', 'count_sp_changes', 'count_estimated_sp_changes'] %}
with prod as (
