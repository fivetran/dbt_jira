...
{% set exclude_columns = ['source_relation', 'open_duration_seconds', 'any_assignment_duration_seconds', 'last_assignment_duration_seconds', 'fixes_versions', 'affects_versions', 'conversation', 'sprint'] + var('consistency_test_exclude_metrics', []) %}
with prod as (
