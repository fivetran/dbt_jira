...
{% set exclude_columns = ['source_relation', 'avg_age_currently_open_seconds', 'avg_age_currently_open_assigned_seconds', 'median_age_currently_open_seconds', 'median_age_currently_open_assigned_seconds', 'epics', 'components'] + var('consistency_test_exclude_metrics', []) %}
